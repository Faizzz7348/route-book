  ...
  (
      ...
      return (
        <>
          ...
          <div
            ref={ref}
            className={cn(
              "fixed inset-y-0 z-50 hidden h-full w-[--sidebar-width-mobile] flex-col border-r bg-sidebar text-sidebar-foreground transition-all duration-300 ease-in-out",
    ...
    return (
      ...
      >
        <div
          className={cn(
            "relative h-screen w-[--sidebar-width] bg-sidebar border-r border-sidebar-border transition-[width] duration-300 ease-in-out",
            state === "collapsed" &&
              collapsible === "icon" &&
