...
export default function KL3Page() {
  const [routes, setRoutes] = useState([
    { no: 1, id: 130, station: "KLCC", schedule: "Daily", route: "KL 3" },
    { no: 2, id: 131, station: "Ampang Park", schedule: "Daily", route: "KL 3" },
    { no: 3, id: 132, station: "Titiwangsa", schedule: "Weekly", route: "KL 3" },
    { no: 4, id: 133, station: "Wangsa Maju", schedule: "Daily", route: "KL 3" },
    { no: 5, id: 134, station: "Sri Rampai", schedule: "Daily", route: "KL 3" },
  ]);
